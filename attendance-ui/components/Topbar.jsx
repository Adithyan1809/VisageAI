      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 rounded-full hover:bg-foreground/10 transition-colors text-muted hover:text-foreground group"
          >
          ...
          {showAlertTip && (
            <div className="absolute right-0 top-12 w-64 z-50 bg-glass-card backdrop-blur-xl border border-glass-border rounded-xl px-4 py-3 shadow-2xl text-xs text-muted leading-relaxed">
              <p className="text-foreground font-semibold mb-1 flex items-center gap-1.5"><Info className="w-3.5 h-3.5 text-brand-cyan" /> System Alerts</p>
          ...
          <AnimatePresence>
            {showUserMenu && (
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 w-64 bg-white/95 dark:bg-[#0d1526]/95 backdrop-blur-xl border border-glass-border rounded-2xl shadow-2xl overflow-hidden z-50"
              >
                {/* User info header */}
                <div className="px-4 py-4 border-b border-glass-border bg-brand-blue/5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-foreground">{user?.full_name || user?.username}</div>
