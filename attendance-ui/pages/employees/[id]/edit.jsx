        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="department_id" defaultValue={employee.department_id || ''} className="mt-1 w-full rounded bg-slate-800 border border-slate-700 px-3 py-2 text-slate-100" />
            </div>
